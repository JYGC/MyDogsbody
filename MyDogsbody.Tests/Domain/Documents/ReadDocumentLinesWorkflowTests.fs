    ...
    let content =
        {
            Words =
                [
                    { Text = "world"; BottomEdgeHeightAboveThePageBottom = 100.0; LeftEdgeDistanceFromThePageLeft = 50.0 }
                    { Text = "Hello"; BottomEdgeHeightAboveThePageBottom = 100.0; LeftEdgeDistanceFromThePageLeft = 10.0 }
                    { Text = "again"; BottomEdgeHeightAboveThePageBottom = 100.0; LeftEdgeDistanceFromThePageLeft = 90.0 }
                ]
        }
...
let ``readDocumentLines returns lines from the top of the page downwards`` () =
    // PDF coordinates grow upwards, so the highest BottomEdgeHeightAboveThePageBottom is the top line
    let content =
        {
            Words =
                [
                    { Text = "bottom"; BottomEdgeHeightAboveThePageBottom = 10.0; LeftEdgeDistanceFromThePageLeft = 10.0 }
                    { Text = "top"; BottomEdgeHeightAboveThePageBottom = 200.0; LeftEdgeDistanceFromThePageLeft = 10.0 }
                    { Text = "middle"; BottomEdgeHeightAboveThePageBottom = 100.0; LeftEdgeDistanceFromThePageLeft = 10.0 }
                ]
        }
...
let ``readDocumentLines groups words within the line tolerance`` () =
    // 100.0 and 100.5 are the same line; 120.0 is not
    let content =
        {
            Words =
                [
                    { Text = "same"; BottomEdgeHeightAboveThePageBottom = 100.0; LeftEdgeDistanceFromThePageLeft = 10.0 }
                    { Text = "line"; BottomEdgeHeightAboveThePageBottom = 100.5; LeftEdgeDistanceFromThePageLeft = 50.0 }
                    { Text = "other"; BottomEdgeHeightAboveThePageBottom = 120.0; LeftEdgeDistanceFromThePageLeft = 10.0 }
                ]
        }
